...
// //     h2H.innerText = `${simpson.name} -- ${simpson.surname}`;
// //     mainDiv.appendChild(h2H);
// //
...
//     h2.innerText = `${courseArray.title}`;
//
//     const paragraf = document.createElement('p');
//     paragraf.style.border = '2px solid darkBlue';
//     paragraf.style.marginTop = '20px';
//     paragraf.innerText = `${courseArray.monthDuration}`;
//
//     const paragraf1 = document.createElement('p');
//     paragraf1.style.border = '2px solid darkBlue';
//     paragraf1.style.marginTop = '20px';
//     paragraf1.innerText = `${courseArray.hourDuration}`;
//
//     const ulDiv = document.createElement('div');
//     ulDiv.style.border = '2px solid darkBlue';
//     ulDiv.style.marginTop = '20px';
//
//     innerDiv.append(h2, paragraf, paragraf1, ulDiv);
//
//     const uL = document.createElement('ul');
//     ulDiv.appendChild(uL);
//
//     for (const module of courseArray.modules) {
